 ...
 */
public class OutputMSIDsDocumentImpl extends net.opengis.xls.impl.MSIDsDocumentImpl implements net.opengis.xls.OutputMSIDsDocument
{
    private static final long serialVersionUID = 1L;
    
    public OutputMSIDsDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
