 ...
 */
@Entity
@Table(name = "routing", schema = "public")
public class Routing implements java.io.Serializable {
	...
	public Routing(int id, Geometry theGeom, double cost,
			double reverseCost, int source, int target, double x1, double y1,
			double x2, double y2, double toCost) {
		this.id = id;
